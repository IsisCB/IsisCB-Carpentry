...
- If the book is a Chapter Book, defined as book which includes chapters which are authored by multiple individuals, then:
...
- If the book is a Single Book, so considered as any book which is not a chapter book as defined, simply ingest the citation into Zotero. No further action is needed until the tagging and classifying step as described below.
- Things to consider:
